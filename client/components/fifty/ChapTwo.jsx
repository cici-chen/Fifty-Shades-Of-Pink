...
const FiftyShadeChapTwo = (props)=>{
  return (
    <div>
        As the cab cruised through the streets of NewYork on this crisp morning, {props.userName} felt a little bit calmer. {props.friendName} had her assistant text {props.userName} the address of the photoshoot who would be bringing all the equipments.
        <br></br>
        <br></br>
        When {props.userName} showed the cab driver the address, the driver recognized the address and said that it's the new luxurious residential coumpound in the city. He had dropped off a famous actress there before, and he wished that the marvelous gardens in there were open to the public, so that he could take his kids to see the exotic trees shipped from South America on the weekend.
        <br></br>
        <br></br>

        Time went by fast as they chatted, and before {props.userName} realized, the car had stopped in front of two grandiose golden gates. The driver buzzed at the security intercom, and a soft-spoken voice came through.
        <br></br>
        <br></br>
        ...
        "{props.loverName} will be here in a minute. We just finished a tennis match and {props.he} needs a shower," Matt said. "Would you like a beer?"
        <br></br>
        <br></br>

        "Ummmm. No thanks I'm not a good drinker. I will probably knock the cameras down after just a few sips." {props.userName} replied with an apologetic smile.
        <br></br>
        <br></br>
        ...
        "Oh..." {props.userName} also laughed, feeling embarrased. "Thank you. That would be great."
    </div>
  )
}

export default FiftyShadeChapTwo
